  ...
  return (parent) => {
    ...
    return {
      setup() {
        ...
        (_a = multiDragParentConfig.multiDragConfig.plugins) == null ? void 0 : _a.forEach((plugin) => {
          var _a2, _b2;
          (_b2 = (_a2 = plugin(parent)) == null ? void 0 : _a2.tearDown) == null ? void 0 : _b2.call(_a2);
        });
        (_b = multiDragParentConfig.multiDragConfig.plugins) == null ? void 0 : _b.forEach((plugin) => {
          var _a2, _b2;
      ...
      tearDownNodeRemap(data) {
        var _a, _b;
        (_b = (_a = multiDragParentConfig.multiDragConfig) == null ? void 0 : _a.plugins) == null ? void 0 : _b.forEach((plugin) => {
          var _a2, _b2;
          (_b2 = (_a2 = plugin(data.parent)) == null ? void 0 : _a2.tearDownNodeRemap) == null ? void 0 : _b2.call(_a2, data);
        });
      },
      tearDownNode(data) {
        var _a, _b;
        (_b = (_a = multiDragParentConfig.multiDragConfig) == null ? void 0 : _a.plugins) == null ? void 0 : _b.forEach((plugin) => {
          var _a2, _b2;
          (_b2 = (_a2 = plugin(data.parent)) == null ? void 0 : _a2.tearDownNode) == null ? void 0 : _b2.call(_a2, data);
        });
      },
      setupNodeRemap(data) {
        var _a, _b;
        (_b = (_a = multiDragParentConfig.multiDragConfig) == null ? void 0 : _a.plugins) == null ? void 0 : _b.forEach((plugin) => {
          var _a2, _b2;
          (_b2 = (_a2 = plugin(data.parent)) == null ? void 0 : _a2.setupNodeRemap) == null ? void 0 : _b2.call(_a2, data);
        });
      },
      setupNode(data) {
        var _a, _b;
        (_b = (_a = multiDragParentConfig.multiDragConfig) == null ? void 0 : _a.plugins) == null ? void 0 : _b.forEach((plugin) => {
          var _a2, _b2;
          (_b2 = (_a2 = plugin(data.parent)) == null ? void 0 : _a2.setupNode) == null ? void 0 : _b2.call(_a2, data);
        });
      }
    };
  };
...
function selectionsEnd(data, state2) {
  ...
  const selectedClass = (_a = data.targetData.parent.data.config.selectionsConfig) == null ? void 0 : _a.selectedClass;
...
function multiDragstart(data) {
  ...
  if (!selectedValues.includes(data.targetData.node.data.value)) {
    ...
    addClass([data.targetData.node.el], selectionConfig == null ? void 0 : selectionConfig.selectedClass, true);
...
function stackNodes({
  ...
  if (data.e instanceof DragEvent) {
    (_a = data.e.dataTransfer) == null ? void 0 : _a.setDragImage(wrapper, x, y);
    setTimeout(() => {
      wrapper.remove();
    });
...
function dragAndDrop({
  ...
  (_a = config.plugins) == null ? void 0 : _a.forEach((plugin) => {
    var _a2, _b2;
    (_b2 = (_a2 = plugin(parent)) == null ? void 0 : _a2.tearDown) == null ? void 0 : _b2.call(_a2);
  });
  (_b = config.plugins) == null ? void 0 : _b.forEach((plugin) => {
    var _a2, _b2;
    (_b2 = (_a2 = plugin(parent)) == null ? void 0 : _a2.tearDown) == null ? void 0 : _b2.call(_a2);
  });
  (_c = config.plugins) == null ? void 0 : _c.forEach((plugin) => {
    var _a2, _b2;
    (_b2 = (_a2 = plugin(parent)) == null ? void 0 : _a2.setup) == null ? void 0 : _b2.call(_a2);
  });
...
function remapNodes(parent, force) {
  ...
  if (!parentData)
    return;
	//my addition
	if (!parentData.getValues(parent)?.length) return
	// end addition
  const enabledNodes = [];
...
function setupNode(data) {
  ...
  (_a = data.parentData.config.plugins) == null ? void 0 : _a.forEach((plugin) => {
    var _a2, _b;
    (_b = (_a2 = plugin(data.parent)) == null ? void 0 : _a2.setupNode) == null ? void 0 : _b.call(_a2, data);
  });
}
function setupNodeRemap(data) {
  ...
  (_a = data.parentData.config.plugins) == null ? void 0 : _a.forEach((plugin) => {
    var _a2, _b;
    (_b = (_a2 = plugin(data.parent)) == null ? void 0 : _a2.setupNodeRemap) == null ? void 0 : _b.call(_a2, data);
  });
}
...
function tearDownNodeRemap(data) {
  ...
  (_a = data.parentData.config.plugins) == null ? void 0 : _a.forEach((plugin) => {
    var _a2, _b;
    (_b = (_a2 = plugin(data.parent)) == null ? void 0 : _a2.tearDownNodeRemap) == null ? void 0 : _b.call(_a2, data);
  });
}
function tearDownNode(data) {
  ...
  if ((_c = (_b = data.nodeData) == null ? void 0 : _b.abortControllers) == null ? void 0 : _c.mainNode) {
    (_e = (_d = data.nodeData) == null ? void 0 : _d.abortControllers) == null ? void 0 : _e.mainNode.abort();
  }
}
...
function end(_eventData, state2) {
  ...
  const dropZoneClass = isTouch ? config == null ? void 0 : config.touchDropZoneClass : config == null ? void 0 : config.dropZoneClass;
  ...
  if (config == null ? void 0 : config.longTouchClass) {
    removeClass(
      state2.draggedNodes.map((x) => x.el),
      (_c = (_b = state2.initialParent.data) == null ? void 0 : _b.config) == null ? void 0 : _c.longTouchClass
    );
  }
  if ("touchedNode" in state2)
    (_d = state2.touchedNode) == null ? void 0 : _d.remove();
}
...
function touchmoveClasses(touchState, config) {
  if (config.longTouchClass)
    removeClass(
      touchState.draggedNodes.map((x) => x.el),
      config == null ? void 0 : config.longTouchClass
    );
...
function dragoverNode3(eventData, dragState) {
  ...
  eventData.e.stopPropagation();
  eventData.targetData.parent.el === ((_a = dragState.lastParent) == null ? void 0 : _a.el) ? sort(eventData, dragState) : transfer(eventData, dragState);
}
function validateSort(data, state2, x, y) {
  ...
  if (data.targetData.node.data.value === state2.lastTargetValue)
    return false;
  if (state2.preventEnter || data.targetData.parent.el !== ((_a = state2.lastParent) == null ? void 0 : _a.el) || data.targetData.parent.data.config.sortable === false)
    return false;
  const targetRect = data.targetData.node.el.getBoundingClientRect();
...
function nodeEventData(callback) {
  function nodeTargetData(node) {
    var _a;
    const nodeData = nodes.get(node);
    const parent = node.parentNode || ((_a = state == null ? void 0 : state.lastParent) == null ? void 0 : _a.el);
    if (!nodeData)
      return;
    const parentData = parents.get(parent);
    if (!parentData)
...
//# sourceMappingURL=@formkit_drag-and-drop.js.map
